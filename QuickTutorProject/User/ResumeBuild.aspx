<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="ResumeBuild.aspx.cs" Inherits="QuickTutorProject.User.ResumeBuild" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlDivision" runat="server" DataSourceID="SqlDataSource1" CssClass="form-contact w-100"
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Division is required"
                                            ...
                                            ControlToValidate="ddlDivision"></asp:RequiredFieldValidator>
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TuitionPortalConnectionString %>" 
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtGraduation" runat="server" CssClass="form-control" 
                                            placeholder="Ex: Bsc. in CSE CGPA 3.50">
                                        </asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtPostGraduation" runat="server" CssClass="form-control" 
                                            placeholder="Ex: Msc. in CSE CGPA 3.80">
                                        </asp:TextBox>
                                    </div>
                                </div>
