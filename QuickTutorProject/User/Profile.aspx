<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="QuickTutorProject.User.Profile" %>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <img src="../assets/img/hero/profile.png" alt="UserPic" class="rounded-circle" width="150" />
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <p class="text-muted font-size-sm text-capitalize">
                                                <i class="fas fa-map-marker-alt"></i> <%# Eval("Division") %>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <asp:Button ID="ButtonDashboard" runat="server" Text="Dashboard" OnClick="ButtonDashboard_Click" CssClass="button button-contactForm boxed-btn" />
                                        </div>
                                    </div>
                                </div>
                            </div>
