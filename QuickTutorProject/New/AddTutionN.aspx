<%@ Page Title="" Language="C#" MasterPageFile="~/New/NewMaster.Master" AutoEventWireup="true" CodeBehind="AddTutionN.aspx.cs" Inherits="QuickTutorProject.New.AddTutionN" %>
     ...
     <div class="container pt-4 pb-4">
         ...
         <div class="row mr-lg-5 ml-lg-5 mb-3">
             <div class="col-md-12 pt-3">
                 ...
                 <asp:TextBox ID="txtSubject" runat="server" CssClass="form-control" placeholder="Enter Required Subjects"
         ...
         <div class="row mr-lg-5 ml-lg-5 mb-3">
             <div class="col-md-6 pt-3">
                 ...
                 <asp:TextBox ID="txtSalary" runat="server" CssClass="form-control" placeholder="Ex: 2500/Month, 7000/Month" required>
                 </asp:TextBox>
             </div>
             <div class="col-md-6 pt-3">
         ...
         <div class="row mr-lg-5 ml-lg-5 mb-3 pt-4">
             <div class="col-md-3 col-md-offset-2 mb-3">
                 <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary btn-block" BackColor="#7200cf" Text="Add Tuition" 
