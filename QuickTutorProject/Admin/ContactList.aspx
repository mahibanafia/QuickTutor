<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ContactList.aspx.cs" Inherits="QuickTutorProject.Admin.ContactList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid pt-4 pb-4">
        <div>
<%--           <asp:Label runat="lblMsg" Text="server"></asp:Label>--%>
        </div>
