...
{
    public partial class TutionList : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        DataTable dt;
        ...
        private void ShowTuition()
        {
            ...
            query = @"Select Row_Number() over(Order by (Select 1)) as [Sr.No], TuitionId, Title, Subject, Duration, PerWeek,
                    Salary, TutoringMethod, Mobile,CreateDate from Tuition";
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("AddTuition.aspx?id=" + e.CommandArgument.ToString());
            }
